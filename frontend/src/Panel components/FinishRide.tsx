        ...
        <div className='mt-10'>
            ...
            <div className=' w-screen flex flex-col justify-between items-center px-2'>
                ...
                <div className='w-full flex flex-col'>
                    <Link to={'/captain-riding'} className='w-full bg-green-500 hover:bg-green-600 active:bg-green-600 text-white font-semibold p-2 flex justify-center rounded-lg'>Finish Ride</Link>
